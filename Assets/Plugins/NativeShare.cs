...
public class NativeShare : MonoBehaviour {
    ...
    public void ShareScreenshotWithText(string text)
    {
		...
		//FileUtil.CopyFileOrDirectory(Application.dataPath + "/Images/MiaHead.png", Application.persistentDataPath + "/" + ScreenshotName);

		StartCoroutine(delayedShare(Application.dataPath + "/Images/MiaHead.png", text));
    }
